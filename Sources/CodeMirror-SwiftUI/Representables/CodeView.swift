...
extension CodeView {
    ...
    public mutating func onLoadSuccess(_ action: @escaping (() -> ())) -> Self {
        self.onLoadSuccess = action
        return self
    }
    
    public mutating func onLoadFail(_ action: @escaping ((Error) -> ())) -> Self {
        self.onLoadFail = action
        return self
    }
    
    public mutating func onContentChange(_ action: @escaping ((String) -> ())) -> Self {
        self.onContentChange = action
        return self
    }
}
